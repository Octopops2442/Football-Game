...
let housePlant = new THREE.Group();
let housePlant2 = new THREE.Group();
...
let tree2Light = new THREE.SpotLight(0xffffff, 3, 100);
tree2Light.castShadow = true;

let plantLight = new THREE.SpotLight(0xffffff, 3, 100);
plantLight.castShadow = true;

let plantLight2 = new THREE.SpotLight(0xffffff, 3, 100);
...
housePlant = loader.createObject(
  "",
  "OBJ Files/eb_house_plant_01.obj",
  housePlant,
  0,
  0,
  0,
...
housePlant2 = loader.createObject(
  "",
  "OBJ Files/eb_house_plant_01.obj",
  housePlant2,
  0,
